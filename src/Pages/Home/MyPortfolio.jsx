  ...
  return (
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <Link to="https://github.com/lindseycarlson23" className="remove--underline" target="_blank"> <button className="btn btn-github">
            <svg
      ...
      <div className="portfolio--section--container">
        {data?.portfolio?.map((item, index) => (
          <Link to={item.deployedlink} className="remove--underline" target="_blank"><div key={index} className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              ...
              <p className="text-sm portfolio--link">
                <Link to={item.githublink} className="remove--underline">View in GitHub</Link>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
